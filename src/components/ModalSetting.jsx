...
function ModalSetting({
  ...
  return (
    <>
      ...
      ></div>
      <div
        className={`max-w-xl bg-white absolute sm:w-96 w-11/12 left-1/2 top-1/2 p-5 rounded-lg ${
          openSetting ? "" : "hidden"
        }`}
      ...
      >
        ...
        <button
          className="bg-green-500 uppercase w-full mt-4 text-white rounded py-2"
